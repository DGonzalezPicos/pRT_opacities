...
species = 'Fe'
# isotopologue_id = dict(Mg=26)
atoms_info = read_csv('atoms_info.csv', index_col=0)
isotopologue_id = dict(Fe=56)
mass = atoms_info.loc[species, 'mass']
...
pRT = dict(
    ...
    make_short_file = '/net/zandkreek/data2/dario/pyexocross/exocross/make_short.f90'
)
